            ...
            <div>
                <div class="cont-details">
                   <div class="table-content table-responsive cart-table-content m-t-30">
                        <h4 style="padding-bottom: 20px;text-align: center;color: blue;">       Appointment Details
                        </h4>
                        <?php
                            $cid=$_GET['aptnumber'];
                            $ret=mysqli_query($con,"select * from bkgtbl join tbluser on tbluser.ID=bkgtbl.userid where bkgtbl.aptnumber='$cid'");
                            $cnt=1;
