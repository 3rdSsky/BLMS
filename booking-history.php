    ...
    <div class="history-table">
        ...
        <tr>
            <?php
                ...
                $query=mysqli_query($con,"select tbluser.ID as uid,tblbook.AptNumber,tblbook.AptDate,tblbook.AptTime,tblbook.Status from tblbook join tbluser on tbluser.ID=tblbook.UserID where tbluser.ID='$userid'");
                    $cnt=1;
