...
$query="select * From adstbl where id=".$onlinebook;
$sql=mysqli_query($con, $query);
 ...
 <form method="post" action="packagedeals.php?action=add&id=<?php echo $row["id"]; ?>" enctype="multipart/form-data">
    ...
    <input type="hidden" name="hidden_name" value="<?php echo $row["adstitle"]; ?>" />  
