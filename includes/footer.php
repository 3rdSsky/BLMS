<section class="w3l-footer-29-main">
    <div class="footer-29 py-5">
      <div class="footer-space container py-lg-4">
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© 2022  Beauty Lounge Management System </p>
  
        <div class="col-lg-4 main-social-footer-29">
          <a href="https://www.facebook.com/profile.php?id=100075955760207" class="facebook"><span class="fa fa-facebook"></span></a>
          <a href="#twitter" class="twitter"><span class="fa fa-twitter"></span></a>
          <a href="https://www.instagram.com/breysbeautylounge/" class="instagram"><span><i class="fa fa-instagram"></i></a>
