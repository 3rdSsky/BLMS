      ...
      <div class="header-right">
        <div class="profile_details_left"><!--notifications of menu start -->
          <ul class="nofitications-dropdown">
            <?php
$ret1=mysqli_query($con,"SELECT blmsdb.bkgtbl.id AS 'bid', blmsdb.tbluser.LastName, blmsdb.tbluser.FirstName, 
                          blmsdb.bkgtbl.aptnumber AS 'AptNumber' FROM blmsdb.tbluser 
