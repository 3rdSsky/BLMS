...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  servicetry set ServiceName='$sername',ServiceDescription='$serdesc',category='$sercategory',Cost='$cost',bookingtime='$serbook' where ID='$eid' ");
    if ($query) {
...
<html>
<head>
<title>BLMS | Update Services</title>
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form method="post">
									  ...
									  <?php
									 $cid=$_GET['editid'];
									$ret=mysqli_query($con,"select * from  servicetry where ID='$cid'");
									$cnt=1;
								...
								<div class="form-group">
							 	...
							 	<div class="form-group"> 
								 	...
								 	<textarea type="text" class="form-control" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"><?php  echo $row['ServiceDescription'];?>
								 	</textarea> 
							 	</div>
								<div class="form-group"> 
								...
								<div class="form-group"> 
							  	...
							  	<input type="text" id="book-time" name="book-time" class="form-control" placeholder="Booking Time" value="<?php echo $row['bookingtime']; ?>" required="true"> 
							 </div>
							 	<div class="form-group"> 
	               	...
	               	<a href="update-image.php?lid=<?php echo $row['id'];?>">Update Image</a> 
							 ...
							 <?php } ?>
							  ...
							  <a href="manage-services.php"><button type="button" class="back-btn btn btn-default"><i class="fa fa-arrow-left"></i> Back</button></a> 
							</form> 
						</div>
