...
<html>
<head>
<title>BLMS || All Appointment</title>
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table id="employee_data" class="main-table2 table table-bordered"> 
							<thead> 
								<tr> 
									<th>#</th> 
...
<a href="all-appointment.php?delid=<?php echo $row['bid'];?>" class="icon-btn btn btn-danger" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o"></i></a>
                                       	</td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
