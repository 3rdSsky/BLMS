...
<html lang="en">
  <head>
    ...
    <title>Beauty Lounge Management System | Invoice History</title>
...
<section class="w3l-contact-info-main" id="contact">
 ...
 $query=mysqli_query($con,"select distinct tbluser.ID as uid, tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tblinvoice2.BillingId,date(tblinvoice2.PostingDate) as PostingDate  from  tbluser   
    join tblinvoice2 on tbluser.ID=tblinvoice2.Userid where tbluser.ID='$userid'order by tblinvoice2.ID desc");
$cnt=1;
